...
//
prompt.get(['title0', 'due0','title1', 'due1','title2', 'due2'], function (err, result) {
    Promise.all([
        sendPOSTtoLacedeamon(result.title0,result.due0),
        sendPOSTtoLacedeamon(result.title1,result.due1),
        sendPOSTtoLacedeamon(result.title2,result.due2)
    ]).then(function (responseArray) {
        console.log('Successfully created. ', responseArray[0].status);
    }, function (response) {
